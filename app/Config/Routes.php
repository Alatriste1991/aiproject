...
$routes->get('verification/(:any)/(:any)', 'User::verification/$1/$2');
$routes->get('resendVerificationEmail/(:any)','User::resendVerificationEmail/$1');
$routes->get('profile/(:any)', 'User::profile/$1');
$routes->get('verification_confirm', 'User::verification_confirm');
